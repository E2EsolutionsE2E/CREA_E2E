...
create table SBS_STG_REL_PRODUCTO
(
...
CREATE UNIQUE INDEX IDX_ODS_REL_PRODUCTO_PK
ON SBS_ODS_REL_PRODUCTO  (COD_CUENTA,TIP_CREDITO,COD_PERIODO);

CREATE TABLE SBS_ODS_REL_PRODUCTO_HIST
( 
	COD_CUENTA         VARCHAR(100)  NOT NULL ,
	COD_SUBPRODUCTO       VARCHAR(10)  NOT NULL ,
	TIP_CREDITO        VARCHAR(100)  NOT NULL ,
...
CREATE UNIQUE INDEX IDX_ODS_REL_PRODUCTO_HIST_PK
ON SBS_ODS_REL_PRODUCTO_HIST  (COD_CUENTA,TIP_CREDITO,COD_PERIODO);
...
( 
	...
	COD_PRODUCTO_BANCARIZACION VARCHAR(100)  NULL ,
	...
	COD_PRODUCTO_COSECHA_PROP VARCHAR(100)  NULL ,
...
( 
	COD_PERIODO        NUMERIC(18,2)  NOT NULL ,
	COD_CLIENTE_SBS    NUMERIC(18,2)  NOT NULL ,
	COD_CLIENTE_PROP    VARCHAR(100)  NULL ,
	TIP_DOCUMENTO_PRIN VARCHAR(100)  NULL ,
	COD_DOCUMENTO_PRIN VARCHAR(100)  NULL ,
	TIP_PERSONA        VARCHAR(100)  NULL ,
	...
	TIP_CLASIFICACION  VARCHAR(100)  NULL ,
...
ON SBS_FACT_CLIENTE (COD_PERIODO ,COD_CLIENTE_SBS, TIP_DOCUMENTO_PRIN, COD_DOCUMENTO_PRIN);
